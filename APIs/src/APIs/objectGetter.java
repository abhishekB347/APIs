    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                // Extract collectionName and sourceName from responseBody using string manipulation
                String collectionName = extractValue(responseBody, "\"collectionName\":\"", "\"");
                String sourceName = extractValue(responseBody, "\"sourceName\":\"", "\"");
